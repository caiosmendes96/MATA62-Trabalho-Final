...
public final class GerenciadorBiblioteca {
    ...
    public static GerenciadorEmprestimos gerenciadorEmprestimos = new GerenciadorEmprestimos();
    public static GerenciadorReservas gerenciadorReservas = new GerenciadorReservas();
    public static GerenciadorUsuarios gerenciadorUsuarios = new GerenciadorUsuarios();
    public static GerenciadorLivros gerenciadorLivros = new GerenciadorLivros();

    private GerenciadorBiblioteca() {
    }

    public static GerenciadorEmprestimos getGerenciadorEmprestimos() {
        return gerenciadorEmprestimos;
    }

    public static void setGerenciadorEmprestimos(GerenciadorEmprestimos gerenciadorEmprestimos) {
        GerenciadorBiblioteca.gerenciadorEmprestimos = gerenciadorEmprestimos;
    }

    public static GerenciadorReservas getGerenciadorReservas() {
        return gerenciadorReservas;
    }

    public static void setGerenciadorReservas(GerenciadorReservas gerenciadorReservas) {
    ...
    public static GerenciadorLivros getGerenciadorLivros() {
        return gerenciadorLivros;
    }

    public static void setGerenciadorLivros(GerenciadorLivros gerenciadorLivros) {
...
// && ChronoUnit.DAYS.between(emprestimo.getDataDevolucaoPrevista(),
// LocalDate.now()) > 0) {
...
// public static Reserva buscarReservaPorCodLivroECodUsuario(int codUsuario, int
// codLivro) {
...
// public static ArrayList<Emprestimo>
// buscarEmprestimosPorCodUsuarioECodLivro(int codUsuario,int codLivro) {

// ArrayList<Emprestimo> emprestimosEncontrados = new ArrayList<>();

// ArrayList<Emprestimo> emprestimosEncontradosPorUsuario =
...
// public static void criarEmprestimo(int codUsuario, int codLivro, int
// tempoEmprestimoUsuario, int codExemplar) {

// emprestimos.add(new Emprestimo(codUsuario, codLivro, tempoEmprestimoUsuario,
// codExemplar));
...
// public static ArrayList<Emprestimo> buscarEmprestimosPorCodUsuario(int
// codUsuario) {
